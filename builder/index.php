...
<head>
    ...
    <link href="assets/css/colorpicker.css" rel="stylesheet" />
		<link href="../assets/css/tsf-wizard.bundle.min.css" rel="stylesheet" />
...
<body>
                                    ...
                                    <div class="bal-element-boxs bal-text-style-box clearfix ">
									    ...
									    <ul class="bal-elements-accordion">
									        <li class="bal-elements-accordion-item" data-type="step-form">
														<a class="bal-elements-accordion-item-title active">Step form settings</a>
									            <div class="bal-elements-accordion-item-content" style="display: block;">
									                <div class="bal-social-content-box ">
    ...
    <script src="assets/js/bal-email-editor.js?v=23"></script>
		<script src="../assets/js/tsf-wizard.bundle.min.js"></script>
